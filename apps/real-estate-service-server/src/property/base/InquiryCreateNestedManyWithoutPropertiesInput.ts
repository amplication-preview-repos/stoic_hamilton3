...
@InputType()
class InquiryCreateNestedManyWithoutPropertiesInput {
...
export { InquiryCreateNestedManyWithoutPropertiesInput as InquiryCreateNestedManyWithoutPropertiesInput };
